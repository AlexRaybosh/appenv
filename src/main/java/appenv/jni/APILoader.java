...
public class APILoader {
    ...
    public final static String SO_LOADER_CLASS_NAME="appenv.jni.SoLoader";
    ...
    static synchronized APIStub load() {
    	try {
    		...
    		return (APIStub) Class.forName("appenv.jni.APIStub").newInstance();
    	} catch (Throwable t) {
...
/*
    ...
    */
    ...
    private static Class< ? > injectSoLoader() throws IOException, ClassNotFoundException, NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            String stubClassName="appenv.jni.APIStub";//APIStub.class.getName();
            String apiClassName="appenv.jni.API";//API.class.getName();
    ...
    */
    ...
    static String readNativeSoVersion() {
    	String v;
		try {
			v = new String(getResourceBytes("/appenv/jni/NATIVE_JAVA_UTILS_SO_VERSION"));
