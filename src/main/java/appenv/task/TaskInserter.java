...
public class TaskInserter {
	...
	public final void insert(ConnectionWrap cw, Collection<TaskRecord> records) throws SQLException, InterruptedException {
		...
		*/
		...
		for (Entry<UnorderedRow<Object>, List<TaskRecord>> e : ticketMap.entrySet()) {
			...
			Object[] taskRow=new Object[] {
					...
					AppEnv.envTypeId(),
					task.getProcessAtMs()==null?AppEnv.getTime():task.getProcessAtMs(),
					task.getPayload(),
	...
	public final TaskFuture submit(TaskRecord task) throws InterruptedException {
